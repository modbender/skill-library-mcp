...
- 在线文档：https://www.luochang.ink/dive-into-langgraph/
...
|------|------|----------|----------|----------|
| 1 | **快速入门** | 创建你的第一个 ReAct Agent | [在线](https://www.luochang.ink/dive-into-langgraph/quickstart/) | [本地](references/1.quickstart.md) |
| 2 | **状态图** | 使用 StateGraph 创建工作流 | [在线](https://www.luochang.ink/dive-into-langgraph/stategraph/) | [本地](references/2.stategraph.md) |
| 3 | **中间件** | 预算控制、消息截断、敏感词过滤、PII 检测 | [在线](https://www.luochang.ink/dive-into-langgraph/middleware/) | [本地](references/3.middleware.md) |
| 4 | **人机交互** | 使用 HITL 中间件实现人机交互 | [在线](https://www.luochang.ink/dive-into-langgraph/human-in-the-loop/) | [本地](references/4.human_in_the_loop.md) |
| 5 | **记忆** | 短期记忆、长期记忆 | [在线](https://www.luochang.ink/dive-into-langgraph/memory/) | [本地](references/5.memory.md) |
| 6 | **上下文工程** | 使用 State、Store、Runtime 管理上下文 | [在线](https://www.luochang.ink/dive-into-langgraph/context/) | [本地](references/6.context.md) |
| 7 | **MCP Server** | 创建 MCP Server 并接入 LangGraph | [在线](https://www.luochang.ink/dive-into-langgraph/mcp-server/) | [本地](references/7.mcp_server.md) |
| 8 | **监督者模式** | 两种方法：tool-calling、langgraph-supervisor | [在线](https://www.luochang.ink/dive-into-langgraph/supervisor/) | [本地](references/8.supervisor.md) |
