...
└── users/
    ├── page.tsx        # /users (page)
    └── route.ts        # ERROR: Conflicts with page.tsx!
```
...
- **Yes**: `async/await`, `cookies()`, `headers()`, Node.js APIs
- **No**: React hooks, React DOM APIs, browser APIs

```tsx
// BAD: React DOM doesn't work in route handlers
