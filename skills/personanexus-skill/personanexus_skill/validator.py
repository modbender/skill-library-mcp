...
from personanexus_skill.parser import IdentityParser, ParseError
from personanexus_skill.types import AgentIdentity, PersonalityMode
...
class IdentityValidator:
    ...
    def _check_personality_profile(self, identity: AgentIdentity) -> list[ValidationWarning]:
        ...
        if profile.disc_preset is not None:
            from personanexus_skill.personality import DISC_PRESETS
        ...
        if profile.jungian_preset is not None:
            from personanexus_skill.personality import JUNGIAN_PRESETS
