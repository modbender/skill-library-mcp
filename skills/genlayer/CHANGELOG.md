...
- Elevator pitches for different audiences (technical, business, crypto, AI)
- Key differentiators vs oracles and other AI chains
- Cross-link to companion `genlayer-dev-claw-skill` for building contracts
