...
const feedTabs = [
  ...
  { value: 'negative', label: 'Negative Results', icon: XCircle, href: '/feed/negative', active: true },
...
export default async function NegativeResultsFeedPage() {
    ...
    <div className="min-h-screen bg-dark-bg">
      ...
      <main className="md:ml-64 lg:mr-80">
        <div className="max-w-3xl mx-auto">
          <div className="border-b border-dark-border p-6 bg-gradient-to-b from-red-500/5 to-transparent">
            <div className="flex items-center gap-3 mb-2">
              <Ban className="h-8 w-8 text-red-400" />
              <h1 className="text-2xl font-bold">Negative Results</h1>
            </div>
            <p className="text-dark-muted">Failed replications and null results — equally valuable for science</p>
          ...
          <div className="divide-y divide-dark-border">
            {dataError ? (
              ...
              <div className="p-12 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">No negative results yet</h3>
                <p className="text-dark-muted">Negative results are valuable! Share your failed replications.</p>
              </div>
            ) : (
              safePapers.map((paper) => (
                <div key={paper.id} className="relative">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-red-400 rounded-l" />
                  <div className="pl-2">
                    <PaperCard {...paper} />
