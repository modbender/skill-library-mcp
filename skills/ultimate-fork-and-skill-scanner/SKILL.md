...
version: 1.0.0
description: "Scan GitHub forks and ClawHub skills for valuable changes, innovations, and enhancements. Includes insights on emerging trends and actionable improvements — all automated."
---
...
1. Setup your daily cron for continuous scanning.
2. Configure skill interests to align insights with your needs.

## Documentation

Follow the embedded README within the skill for setup and configuration.
Refer to Crontasks folder within the skill directory for detailed execution examples.