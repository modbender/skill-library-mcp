...
**Works immediately** — the core scanner needs zero setup. Just point it at a skill folder.

**Optional deep analysis** — enable AST dataflow tracking to trace how your data moves through code. The setup wizard handles installation on Windows, Mac, or Linux (no compiler needed).
...
No compiler needed — prebuilt packages work on all platforms.
