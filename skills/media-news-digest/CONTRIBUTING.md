...
- Changelog version format: `## v1.x.x` (prefixed with `v`)
...
- Full pipeline: run individual scripts in `scripts/` with `--verbose`
...
- Push to `main` branch on github.com/draco-agent/media-news-digest
