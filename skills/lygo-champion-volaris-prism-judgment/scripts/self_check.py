"""Self-check for the LYGO Root: VOLARIS skill pack.
...
if canon.get("champion") != "VOLARIS":
    print("BAD_CANON: champion != VOLARIS")
    raise SystemExit(2)

if canon.get("anchor_label") != "VOLARIS_REFRACTOR_CODEX":
