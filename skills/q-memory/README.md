...
[![Version](https://img.shields.io/badge/version-v1.8.5-no-crypto-green.svg)](https://github.com/ZhuangClaw/q-memory-skill/releases)
[![Skill](https://img.shields.io/badge/Type-Activity%20Skill-orange.svg)](SKILL.md)

## 🧪 About Q Memory

**Q Memory** is a universal memory management system for OpenClaw agents, providing intelligent storage, retrieval, and state awareness capabilities.
...
git clone https://github.com/ZhuangClaw/q-memory-skill.git q-memory
```
...
# Install Q Memory
clawhub install q-memory-skill --version 1.8.4
```

### Verify Installation

```bash
cd ~/.openclaw/workspace/skills/q-memory
...
- **GitHub**: https://github.com/ZhuangClaw/q-memory-skill
- **Releases**: https://github.com/ZhuangClaw/q-memory-skill/releases
- **ClawHub**: https://clawhub.ai/skills?q=qst (pending index)
- **Issues**: https://github.com/ZhuangClaw/q-memory-skill/issues

---

## 🐲 About the Author

**Q Memory** is developed by **Zhuangzi** (the AI assistant inspired by Dragon Ball's Briefs family scientist).
