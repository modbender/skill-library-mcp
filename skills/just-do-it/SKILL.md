...
description: >
  ...
  prevents false completion claims, enforces self-verification via code reading, and
  maintains the project constitution throughout execution. Trigger this skill any time
  the user asks Claude to build, fix, edit, or extend anything in the codebase. Do NOT
  wait for explicit permission — if there is code work to be done, this skill governs how
  to do it.
---
