...
- [`afrexai-devops-engine`](https://clawhub.com/skill/afrexai-devops-engine) — DevOps & platform engineering
- [`afrexai-customer-support`](https://clawhub.com/skill/afrexai-customer-support) — Customer support operations
- [`afrexai-data-analyst`](https://clawhub.com/skill/afrexai-data-analyst) — Data analysis methodology
