# FRED Macro Indicators Reference

## Key Indicators (Pre-configured)

| Name | FRED ID | Description | Frequency |
|------|---------|-------------|-----------|
...
| ism | MANEMP | Manufacturing Employment | Monthly |
| vix | VIXCLS | VIX Volatility Index | Daily |

## Other Useful FRED Series
...
- **Near zero/negative**: Recession signal (inverted yield curve)

### VIX
- **<15**: Low volatility, complacent market
- **15-25**: Normal
- **25-35**: Elevated fear
- **>35**: Extreme fear / market stress

### Fed Funds Rate
- **Rising**: Tightening policy (bearish for stocks)
- **Falling**: Easing policy (bullish for stocks)
