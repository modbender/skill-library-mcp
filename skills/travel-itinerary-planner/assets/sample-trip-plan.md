# Kyoto, Japan Trip Plan (2026-04-03 to 2026-04-05)

Generated on: 2026-02-27

## Trip Snapshot
- Destination: Kyoto, Japan
- Dates: 2026-04-03 to 2026-04-05 (3 days)
...
## Cover Image
Add one trusted HTTPS cover image URL.
...
### Day 1 | 2026-04-03 | Theme: food
- Morning: [Plan specific food activity #1]
- Afternoon: [Plan specific food activity #2]
- Evening: [Plan specific food activity #3]
...
- Pace note: moderate pace with buffer time

### Day 2 | 2026-04-04 | Theme: temples
- Morning: [Plan specific temples activity #1]
- Afternoon: [Plan specific temples activity #2]
- Evening: [Plan specific temples activity #3]
- Transit: [Estimate travel time between stops and mode]
- Reservation flags: [List activities requiring advance booking]
- Rain backup: [Indoor alternative for the main activity]
- Pace note: moderate pace with buffer time

### Day 3 | 2026-04-05 | Theme: food
- Morning: [Plan specific food activity #1]
- Afternoon: [Plan specific food activity #2]
- Evening: [Plan specific food activity #3]
- Transit: [Estimate travel time between stops and mode]
...
- Arrival route from Shanghai, China: [Fill exact flight/train plan]
- Local move strategy: [metro/walk/taxi mix with peak-hour notes]
- Destination map: [Kyoto, Japan map](https://www.google.com/maps/search/Kyoto%2C+Japan)
- Suggested base area: [city center search](https://www.google.com/maps/search/Kyoto%2C+Japan+city+center)
- Transit hub reference: [main station / airport](https://www.google.com/maps/search/Kyoto%2C+Japan+main+station)
...
| --- | ---: | ---: |
| Lodging | CNY 420 | CNY 2,520 |
| Food | CNY 220 | CNY 1,320 |
| Local transport | CNY 110 | CNY 660 |
| Attractions and tickets | CNY 180 | CNY 1,080 |
| Misc | CNY 110 | CNY 660 |

- Rough total (excluding long-distance transport): CNY 6,240
