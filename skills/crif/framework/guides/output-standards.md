...
This guide defines universal quality standards that apply to **all outputs** from the CRIF framework, regardless of workflow type.
...
These criteria apply to **all outputs** from CRIF framework.
