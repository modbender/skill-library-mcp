"""Self-check for the LYGO Champion: SRAITH skill pack.
...
if canon.get("champion") != "SRAITH":
    print("BAD_CANON: champion != SRAITH")
    raise SystemExit(2)

if canon.get("anchor_label") != "SRAITH_MIRRORFACE_SENTINEL":
