"""Self-check for the LYGO Champion: OMNISIREN skill pack.
...
if canon.get("champion") != "OMNISIREN":
    print("BAD_CANON: champion != OMNISIREN")
    raise SystemExit(2)

if canon.get("anchor_label") != "OMNISIREN_SILENT_STORM_COLLAPSE":
