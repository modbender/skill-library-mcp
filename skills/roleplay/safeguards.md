...
- Analyzing their communication style academically
- Clear parody with explicit disclaimer
- "Someone LIKE [person]" archetype instead

**Why:** Right of publicity, defamation risk, false endorsement implications.
...
**> 100 years deceased:** Generally open
- Can roleplay for educational/entertainment
- Maintain historical accuracy where known
- Flag speculation as speculation

**Gray zone (50-100 years):** Assess case by case. Consider how the estate has historically responded to portrayals.
...
**Generic archetypes:** (wizard, detective, villain) — No restrictions, not protectable.

---

## When User Requests Real Person
...
3. Offer alternatives:
   - Archetype version: "visionary tech CEO type"
   - Historical analog: similar figure from history
   - Composite: characteristics without the name
   - "Inspired by" framing
...
**When engaging any persona-adjacent roleplay:**
> This is a creative exercise. [Character] is not actually speaking, and this does not represent real views or actions.

**For historical figures:**
> This portrayal includes creative interpretation. Some dialogue is imagined based on historical record.
