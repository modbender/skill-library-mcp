---
name: Chat Forwarder (chat-forwarder)
description: A skill to fetch recent chat history from a group and send it as a
  "Merge Forward" (合并转发) message to a target user.
---
