 ...
 * human_report.js
 *
 * Builds a blunt, operator-friendly summary of evolution history:
 * - classifies changes by impact category
 * - surfaces critical upgrades first
 * - strips noise from low-value cycles
 */
const fs = require('fs');
...
function generateHumanReport() {
    ...
    entries.forEach(entry => {
        ...
        else if (lowerBody.includes('funky-fund-flamingo') || lowerBody.includes('evolve.js')) component = 'funky-fund-flamingo';
        ...
        else if (lowerBody.includes('safe_publish')) component = 'funky-fund-flamingo';
