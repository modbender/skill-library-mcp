# LYGO-MINT Verifier — Usage (for Lightfather vector)
...
How to use with Lightfather:
- Ask: “Mint this alignment pack” + paste the pack text / file path.
- Ask: “Show the hash + anchor snippet.”
- Ask: “Backfill anchors” after posting (paste URLs/ids).

Rule:
- Any change => new hash => new public anchor.
