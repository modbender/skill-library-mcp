...
description: This skill allows agents to securely access and manage secrets
  using the 1Password CLI (op) and a Service Account. It provides commands for
  reading, writing, and managing items within a dedicated v...
---
