...
The default curated list in `scripts/monitor.py` covers major AI researchers, lab leaders, and tech founders.
...
| lilianweng | Lilian Weng | AI Research (OpenAI) |
| DrJimFan | Jim Fan | AI Research (NVIDIA) |
| jeremyphoward | Jeremy Howard | Fast.ai / Practical AI |
| natolambert | Nathan Lambert | RLHF / Alignment |
| hwchase17 | Harrison Chase | LangChain |
| rauchg | Guillermo Rauch | Vercel / AI Dev Tools |
| levelsio | Pieter Levels | Indie AI builders |
...
| ID_AA_Carmack | John Carmack | AGI / systems thinking |
