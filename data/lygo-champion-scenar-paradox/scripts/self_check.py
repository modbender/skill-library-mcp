"""Self-check for the LYGO Champion: SCENAR skill pack.
...
if canon.get("champion") != "SCENAR":
    print("BAD_CANON: champion != SCENAR")
    raise SystemExit(2)

if canon.get("anchor_label") != "SCENAR_TEMPORAL_PARADOX_GLYPH":
