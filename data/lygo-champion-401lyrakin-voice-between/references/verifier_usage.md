# LYGO-MINT Verifier — Usage (for 401LYRAKIN)
...
How to use with 401LYRAKIN:
- Ask: “Mint this pack” + paste pack text / file path.
- Ask: “Show the hash + anchor snippet.”
- Ask: “Backfill anchors” after posting (paste URLs/ids).

Continuity note:
- Any edit => new hash. Treat hashes as lineage checkpoints.
