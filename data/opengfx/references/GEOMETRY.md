...
### 1. Circle
**Construction:** Point → infinite equidistant points
**Meaning:** Wholeness, containment, unity, protection, cycles, continuity
**Psychology:** Inclusive, complete, eternal, feminine, soft
**Best for:** Collectives, non-profits, global organizations, communities, wellness

**Famous examples:** Target, Mastercard, Spotify, BMW, Starbucks (contains)
...
### 2. Line / Cross
**Construction:** Two points connected; perpendicular intersection
**Meaning:** Connection, relationship, intersection, balance, crossroads
**Psychology:** Direction, meeting point, cooperation, medical/spiritual
**Best for:** Healthcare, intersections of two purposes, partnerships, navigation

**Famous examples:** Red Cross, + symbol, Mercedes (three-way), intersecting forms
...
### 3. Triangle
**Construction:** Three non-collinear points connected
**Meaning:** Direction, stability, hierarchy, aspiration, change
**Psychology:** Dynamic, masculine, sharp, directional, powerful
**Best for:** Tech, automotive, aerospace, advancement, performance

**Famous examples:** Adidas, Delta, Mitsubishi, Google Play, Caterpillar
...
### 4. Square / Rectangle
**Construction:** Four right angles, parallel sides
**Meaning:** Stability, reliability, equality, structure, containment
**Psychology:** Grounded, trustworthy, solid, organized, masculine
**Best for:** Finance, construction, legal, enterprise, institutions

**Famous examples:** Microsoft, American Express, Unilever, National Geographic

**Construction grid:**
```
  ┌─────────┐
  │         │   Equal sides = perfect balance
  │         │   Rectangle = dynamic stability
  └─────────┘
```

### 5. Spiral
**Construction:** Continuous curve from center outward
**Meaning:** Growth, evolution, creativity, natural progression, infinity
**Psychology:** Organic, dynamic, expanding, creative, transformative
**Best for:** Creative agencies, growth companies, nature-connected brands

**Famous examples:** Fibonacci-based marks, shell forms, growth indicators
...
```
1 : 1.618 ratio for spacing, scaling, positioning
Used by: Apple, Twitter, Pepsi, Toyota
```

### Circle Packing
```
Multiple circles of related sizes
Used by: Olympics, Audi, Mastercard
```

### Geometric Subdivision
```
Single shape divided into meaningful parts
Used by: NBC peacock, Mitsubishi, Mercedes
```
