"""Pydantic models for the AI PersonaNexus Framework v1.0 — with board extension."""
...
class AgentIdentity(BaseModel):
    ...
    board: BoardConfig = Field(default_factory=BoardConfig)  # Board of Directors extension
