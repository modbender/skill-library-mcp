"""Wan2.2 Image-to-Video Flash generation endpoint."""
...
ENDPOINT = ModelEndpoint(
    model_id="alibaba/wan2.2-i2v-flash",
    action="generation",
    provider="alibaba",
    model_name="wan2.2-i2v-flash",
    description="Generate videos from images using Wan2.2 Image-to-Video Flash model (50% faster)",
    input_types=[InputType.IMAGE, InputType.TEXT],
    output_type=OutputType.VIDEO,
    api_path="/vendors/alibaba/v1/wan2.2-i2v-flash/generation",
    result_key="videos",
...
class Wan22I2VFlashGeneration(BaseModelEndpoint):
    """Wan2.2 Image-to-Video Flash generation endpoint."""
...
def main() -> int:
    """CLI entry point."""
    return Wan22I2VFlashGeneration().run()
