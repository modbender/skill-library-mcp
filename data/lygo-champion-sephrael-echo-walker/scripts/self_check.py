"""Self-check for the LYGO Champion: SEPHRAEL skill pack.
...
if canon.get("champion") != "SEPHRAEL":
    print("BAD_CANON: champion != SEPHRAEL")
    raise SystemExit(2)

if canon.get("anchor_label") != "SEPHRAEL_TRUTHWAVE_ANCHOR":
