#!/bin/bash
# TripGo API - All-Day Routing Between Events (DEPRECATED)
# Endpoint: POST /skedgoify.json
# Documentation: https://developer.tripgo.com/#/routing/paths/~1skedgoify.json/post
#
...
usage() {
    ...
    echo ""
    echo "⚠️  DEPRECATED: This endpoint is deprecated. Use /agenda/run instead."
    echo ""
...
echo "⚠️  WARNING: This endpoint (/skedgoify.json) is DEPRECATED."
echo "   Please use /agenda/run instead."
echo ""
...
# Make the request
echo "Making POST request to: ${BASE_URL}/skedgoify.json (DEPRECATED)"
echo "Payload:"
