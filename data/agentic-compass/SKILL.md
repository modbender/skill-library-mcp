---
name: Agentic Compass — AI Agent Self-Reflection Tool
description: Local-only self-reflection that forces objective action for AI
  agents. No data leaves your machine.
---
