#!/usr/bin/env python3
\"\"\"Run sleep analysis and print JSON to stdout (and optional file).\"\"\"
...
def main() -> int:
    parser = argparse.ArgumentParser(description=\"Sleep analysis (last 30h by default).\")
    ...
    parser.add_argument(\"--window-hours\", type=int, default=30, help=\"Hours to look back (default: 30).\")
