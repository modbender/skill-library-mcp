...
import { resolveCredentials, type TwitterCookies } from '@steipete/bird';
...
// Shared options
const addAuthOptions = (cmd: Command) => {
  return cmd
...
async function getCookies(opts: any): Promise<TwitterCookies> {
