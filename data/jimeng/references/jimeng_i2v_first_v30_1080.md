...
<span id="7CyoBPYL"></span>
# 接入说明
<span id="Unz2O4w0"></span>
## 请求说明
...
<span id="6Z67rA4r"></span>
## 提交任务
<span id="ssImhVjW"></span>
### **提交任务请求参数**
<span id="1brzpTOL"></span>
#### **Query参数**
...
<span id="cAZE2FgM"></span>
### 提交任务返回参数
<span id="6iqzTFoY"></span>
#### **通用返回参数**
请参考[通用返回字段及错误码](https://www.volcengine.com/docs/6444/69728)
<span id="hF1SRqMN"></span>
#### **业务返回参数**
...
<span id="huYCO4pg"></span>
## 查询任务
<span id="CguQZUYe"></span>
### **查询任务请求参数**
<span id="hQyt7e1v"></span>
#### **Query参数**
...
<span id="G7eIRf0r"></span>
#### **Header参数**
:::warning
本服务固定值：**Region为cn\-north\-1，Service为cv**
:::
主要用于鉴权，详见 [公共参数](https://www.volcengine.com/docs/6369/67268) \- 签名参数 \- 在Header中的场景部分
<span id="0khexytY"></span>
#### **Body参数**
:::warning
业务请求参数，放到request.body中，MIME\-Type为**application/json**
...
<span id="mweaPqvD"></span>
### 查询任务返回参数
<span id="j2EdhGPg"></span>
#### **通用返回参数**
请参考[通用返回字段及错误码](https://www.volcengine.com/docs/6444/69728)
<span id="ONMPMjIJ"></span>
#### **业务返回参数**
:::tip
...
<span id="cj3eX2Fh"></span>
## 错误码
<span id="FkVAGvvV"></span>
### **通用错误码**
请参考[通用返回字段及错误码](https://www.volcengine.com/docs/6444/69728)
<span id="uWlQhhnU"></span>
### **业务错误码**
...
&nbsp;
<span id="rkkGEoZu"></span>
## 接入说明
<span id="YRQuYjTR"></span>
### SDK使用说明
请参考[SDK使用说明](https://www.volcengine.com/docs/6444/1340578)
<span id="r6hSA0Jy"></span>
### HTTP方式接入说明
